use [CookChild20-0612]

declare @facility	varchar(50)		= 'COOCHI'		--select * from aims.cod where TYPE='y' order by name 
...
declare @start		date	= convert(varchar(2),datepart(month,(dateadd(month,-1,getdate()))))
								+ '/1/'
